...
if __name__ == "__main__":
    # 실제 파일 경로로 수정하세요
    PCD1_PATH = "/media/myungw00/2TB_SSD/kitti/result/pcd/original_pcd/000000.pcd"
    PCD2_PATH = "/home/myungw00/ROS2/upsample_ws/depth_any_ws/Depth-Anything-V2/output/00000_tr.pcd"
    Z_OFFSET = -3  # 원하는 만큼 z축 오프셋(m 단위 등)을 입력
